...
WebUI.sendKeys(findTestObject('Object Repository/Page_Swag Labs/input_password'), Keys.chord(Keys.ENTER))
...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_firstName'), 'levi')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_lastName'), 'james')

WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_postalCode'), '450005')

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_lastName'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_postalCode'))
